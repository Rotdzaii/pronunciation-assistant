...
OUTPUT_NAMES = (
    "r5_2b_tc1_pa1_preflight.json",
    "r5_2b_tc1_pa1_path_guard.json",
    "r5_2b_tc1_pa1_population_accounting.json",
    "r5_2b_tc1_pa1_candidate_audit.json",
    "r5_2b_tc1_pa1_train_scores.jsonl",
    "r5_2b_tc1_pa1_continuous_metrics.json",
    "r5_2b_tc1_pa1_loso_thresholds.json",
    "r5_2b_tc1_pa1_oof_predictions.jsonl",
    "r5_2b_tc1_pa1_binary_metrics.json",
    "r5_2b_tc1_pa1_relation_cohort_metrics.json",
    "r5_2b_tc1_pa1_event_metrics.json",
    "r5_2b_tc1_pa1_gate_results.json",
    "r5_2b_tc1_pa1_protocol_audit.json",
    "r5_2b_tc1_pa1_final_status.json",
    "r5_2b_tc1_pa1_compute_report.json",
    "R5_2B_TC1_PA1_TRAIN_DEVELOPMENT_RESULT.md",
    "R5_2B_TC1_PA1_EXECUTION_MANIFEST.json",
)
...
def build_report(accounting: dict[str, Any], audit: dict[str, Any], continuous: dict[str, Any], folds: list[dict[str, Any]], binary: dict[str, Any], cohorts: dict[str, Any], events: dict[str, Any], gates: dict[str, Any], status: str) -> str:
    ...
    lines = [
        "# R5-2B-TC1-PA1 Frozen TRAIN Development Result", "", f"Status: `{status}`", "",
        "## Population", "",
...
def execute() -> None:
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_path_guard.json", path_guard)
    ...
    preflight = {
        "status": "PASS",
        "execution_label": "PATH-CORRECTED CONTINUATION OF THE PRE-METRIC R5-2B EXECUTION",
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_preflight.json", preflight)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_population_accounting.json", accounting)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_candidate_audit.json", audit)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_continuous_metrics.json", continuous)

    predictions, folds = run_loso(words, scores)
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_loso_thresholds.json", {
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_binary_metrics.json", binary)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_relation_cohort_metrics.json", relation_cohorts)
    events = event_metrics(words, predictions, scored)
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_event_metrics.json", events)
    ...
    write_jsonl(EXPERIMENT_DIR / "r5_2b_tc1_pa1_train_scores.jsonl", score_rows)
    write_jsonl(EXPERIMENT_DIR / "r5_2b_tc1_pa1_oof_predictions.jsonl", oof_rows)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_gate_results.json", gates)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_protocol_audit.json", protocol)
    final = {
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_final_status.json", final)
    compute = {
        ...
        "pa1_path_guard": path_guard, "tc1_preflight": adapter_check, "inference": inference_report,
        "scoring": scoring_report, "total_seconds_before_hashing": time.perf_counter() - started,
    }
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_compute_report.json", compute)
    report = build_report(accounting, audit, continuous, folds, binary, relation_cohorts, events, gates, status)
    (EXPERIMENT_DIR / "R5_2B_TC1_PA1_TRAIN_DEVELOPMENT_RESULT.md").write_text(report, encoding="utf-8")

    artifact_names = ["r5_2b_train_execution_driver_tc1_pa1.py"] + [
        name for name in OUTPUT_NAMES if name != "R5_2B_TC1_PA1_EXECUTION_MANIFEST.json"
    ]
    entries = [
    ...
    manifest = {
        "manifest_type": "additive path-corrected R5-2B-TC1-PA1 frozen TRAIN execution manifest", "self_excluded": True,
    ...
    write_json(EXPERIMENT_DIR / "R5_2B_TC1_PA1_EXECUTION_MANIFEST.json", manifest)
    print(json.dumps({
        "status": status, "gates_passed": passed_count, "manifest_sha256": sha256(EXPERIMENT_DIR / "R5_2B_TC1_PA1_EXECUTION_MANIFEST.json"),
