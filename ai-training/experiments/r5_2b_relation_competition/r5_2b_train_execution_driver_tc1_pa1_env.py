...
MANUAL_TEXTGRID_ROOT = Path(
    r"C:\Users\Admin\Documents\KLTN\pronunciation-assistant\ai-training\datasets\l2-arctic\raw\l2arctic_release_v5.0"
)
AUDIO_ROOT = Path(
    r"C:\Users\Admin\Documents\KLTN\pronunciation-assistant\ai-training\datasets\l2-arctic\raw\l2arctic_release_v5.0"
)
V4_METADATA_ROOT = Path(
    r"C:\Users\Admin\Documents\KLTN\pronunciation-assistant-research\ai-training\datasets\l2-arctic\metadata"
)
...
import r5_2b_tc1_numeric_guard as tc1_guard  # noqa: E402
...
V4_PATH = V4_METADATA_ROOT / "all_speakers_expected_observed_v4.csv"
...
FAILED_EXECUTION_MANIFEST = EXPERIMENT_DIR / "R5_2B_EXECUTION_MANIFEST.json"
TC0_MANIFEST = EXPERIMENT_DIR / "R5_2B_TC0_MANIFEST.json"
TC1_CONTRACT = EXPERIMENT_DIR / "R5_2B_TC1_TECHNICAL_CORRECTION_CONTRACT.json"
TC1_CONTRACT_MANIFEST = EXPERIMENT_DIR / "R5_2B_TC1_CONTRACT_MANIFEST.json"
TC1_STATIC_MANIFEST = EXPERIMENT_DIR / "R5_2B_TC1_STATIC_MANIFEST.json"
TC1_GUARD = EXPERIMENT_DIR / "r5_2b_tc1_numeric_guard.py"
PREVIOUS_CORRECTED_EXECUTION_MANIFEST = EXPERIMENT_DIR / "R5_2B_TC1_EXECUTION_MANIFEST.json"
PA0_MANIFEST = EXPERIMENT_DIR / "R5_2B_PA0_MANIFEST.json"
PA1_CONTRACT = EXPERIMENT_DIR / "R5_2B_PA1_PATH_CORRECTION_CONTRACT.json"
PA1_PREREGISTRATION = EXPERIMENT_DIR / "R5_2B_PA1_PREREGISTRATION.md"
PA1_MANIFEST = EXPERIMENT_DIR / "R5_2B_PA1_MANIFEST.json"
LATEST_FAILED_EXECUTION_MANIFEST = EXPERIMENT_DIR / "R5_2B_TC1_PA1_EXECUTION_MANIFEST.json"
ENVIRONMENT_PROVENANCE = EXPERIMENT_DIR / "r5_2b_environment_provenance.json"
ENVIRONMENT_IMPORT_CHECK = EXPERIMENT_DIR / "r5_2b_environment_import_check.json"
ENVIRONMENT_PROTOCOL_AUDIT = EXPERIMENT_DIR / "r5_2b_environment_protocol_audit.json"
ENVIRONMENT_LAUNCHER = EXPERIMENT_DIR / "r5_2b_environment_launcher.json"
AUTHORIZED_INTERPRETER = Path(
    r"C:\Users\Admin\Documents\KLTN\pronunciation-assistant\ai-training\.venv\Scripts\python.exe"
)
...
EXPECTED_SHA = {
    ...
    "failed_execution_manifest": "92163F8DE3ECEAFEE2950AF57302AA565C0F3612A2D6F0D36462552FA66BA09E",
    "tc0_manifest": "91F5DBCB9719FEF7C7E3E1CEF5773E92A18B813FFD54384359DF026F300C278E",
    "tc1_contract": "632F32CEF2F8EE05A47ACA7FFCE97FB5DA35236C48B53E25EC06CEFCDACE954F",
    "tc1_contract_manifest": "545C49597D3648CCBD70DB57436E8A58D01CD1D0F7DC813C854D5B3F83B56CC0",
    "tc1_static_manifest": "462C7966B01B5858EB9D4A20F23ECF1A17EACD6430BB233A37A4E7EDA7A9DF63",
    "tc1_guard": "E18550F191FE6933C98F21169E30E6482AA9AAE147B013024982D384E49299D8",
    "previous_corrected_execution_manifest": "605941841092EA2D52D2773981FBB8D39E91738114F415AAFEF059EC536B521C",
    "pa0_manifest": "8D17C47786AC8A4167C19A5A5C37291EDAA31DBD54505E8638CE591DD581182C",
    "pa1_contract": "F02A497648D9D707521C3289C85755D75A5E5C3440BA97499F51C4EF677820B6",
    "pa1_preregistration": "546373878FC019C6EA0F5722F82C32C9FC363C0B506447F30866BD6FC59AB915",
    "pa1_manifest": "DF209C8376F18C82F6212508208D3856046BABBEB1351CE11E62BC33F24B2451",
    "latest_failed_execution_manifest": "49538C3DD9804DBC50806A420557F7AD1AF299E7A48541BCEC9FA30AF91E80A3",
    "environment_provenance": "7C8BB716A428290163B8AAA3B7A48EEE4C6700298E841D1665BACB604DC6876A",
    "environment_import_check": "1D2248FFDE92FED2B24ED0B00884F452C9F1EC1A5D21B731FC127BD161225FD5",
    "environment_protocol_audit": "5FD7A31226E0F8D8E2B8B75CC66C9465891375C3E1149DA8B59EF0AF8D425C71",
    "environment_launcher": "50C57A14E2DB14AB84DBF5A71574A4B44226653EFC6EE5953C151D14B47D7891",
}
IDENTITY_PATHS = {
    ...
    "failed_execution_manifest": FAILED_EXECUTION_MANIFEST,
    "tc0_manifest": TC0_MANIFEST,
    "tc1_contract": TC1_CONTRACT,
    "tc1_contract_manifest": TC1_CONTRACT_MANIFEST,
    "tc1_static_manifest": TC1_STATIC_MANIFEST,
    "tc1_guard": TC1_GUARD,
    "previous_corrected_execution_manifest": PREVIOUS_CORRECTED_EXECUTION_MANIFEST,
    "pa0_manifest": PA0_MANIFEST,
    "pa1_contract": PA1_CONTRACT,
    "pa1_preregistration": PA1_PREREGISTRATION,
    "pa1_manifest": PA1_MANIFEST,
    "latest_failed_execution_manifest": LATEST_FAILED_EXECUTION_MANIFEST,
    "environment_provenance": ENVIRONMENT_PROVENANCE,
    "environment_import_check": ENVIRONMENT_IMPORT_CHECK,
    "environment_protocol_audit": ENVIRONMENT_PROTOCOL_AUDIT,
...
EXPECTED_TRAIN_ANNOTATIONS = {
    "BWC": 150, "EBVS": 150, "HJK": 150, "NCC": 150, "NJS": 150, "PNV": 150,
    "RRBI": 150, "TLV": 150, "TNI": 150, "YBAA": 149, "YKWK": 150, "ZHAA": 150,
}
FIRST_ANNOTATION_RELATIVE_PATH = Path("BWC") / "annotation" / "arctic_a0006.TextGrid"
FIRST_ANNOTATION_SIZE = 8123
FIRST_ANNOTATION_SHA256 = "EF3056511B71013C399F5F69F40B6A8865756FE26091DF72CC5EDB8E7D14A337"
OUTPUT_NAMES = (
    "r5_2b_tc1_pa1_env_preflight.json",
    "r5_2b_tc1_pa1_env_path_guard.json",
    "r5_2b_tc1_pa1_env_population_accounting.json",
    "r5_2b_tc1_pa1_env_candidate_audit.json",
    "r5_2b_tc1_pa1_env_train_scores.jsonl",
    "r5_2b_tc1_pa1_env_continuous_metrics.json",
    "r5_2b_tc1_pa1_env_loso_thresholds.json",
    "r5_2b_tc1_pa1_env_oof_predictions.jsonl",
    "r5_2b_tc1_pa1_env_binary_metrics.json",
    "r5_2b_tc1_pa1_env_relation_cohort_metrics.json",
    "r5_2b_tc1_pa1_env_event_metrics.json",
    "r5_2b_tc1_pa1_env_gate_results.json",
    "r5_2b_tc1_pa1_env_protocol_audit.json",
    "r5_2b_tc1_pa1_env_final_status.json",
    "r5_2b_tc1_pa1_env_compute_report.json",
    "R5_2B_TC1_PA1_ENV_TRAIN_DEVELOPMENT_RESULT.md",
    "R5_2B_TC1_PA1_ENV_EXECUTION_MANIFEST.json",
)
...
def verify_authorized_environment() -> dict[str, Any]:
    import pandas
    import sklearn
    ...
    observed = {
        ...
        "gpu_device_name": torch.cuda.get_device_name(0) if device_count else None,
        "numpy_version": np.__version__,
        "pandas_version": pandas.__version__,
        "sklearn_version": sklearn.__version__,
    }
    expected = {"sys_executable": str(AUTHORIZED_INTERPRETER.resolve()), **EXPECTED_ENVIRONMENT}
    mismatches = {
    ...
    if mismatches:
        raise RuntimeError(f"R5_2B_ENVIRONMENT_NOT_READY: {mismatches}")
    return {
        "status": "PASS",
        "correction_category": "EXECUTION_ENVIRONMENT_SELECTION_ONLY",
        "expected": expected,
        "observed": observed,
        "absolute_interpreter_match": True,
...
def verify_identities() -> dict[str, Any]:
    ...
    if mismatch:
        raise RuntimeError(f"R5_2B_TC1_PA1_EXECUTION_BLOCKED_IDENTITY: {mismatch}")
    manifest_paths = {
        "contract": CONTRACT_MANIFEST,
        "original_static": STATIC_MANIFEST,
        "failed_execution": FAILED_EXECUTION_MANIFEST,
        "tc0": TC0_MANIFEST,
        "tc1_contract": TC1_CONTRACT_MANIFEST,
        "tc1_static": TC1_STATIC_MANIFEST,
        "previous_corrected_execution": PREVIOUS_CORRECTED_EXECUTION_MANIFEST,
        "pa0": PA0_MANIFEST,
        "pa1": PA1_MANIFEST,
        "latest_failed_execution": LATEST_FAILED_EXECUTION_MANIFEST,
    }
    manifest_audits = {name: verify_manifest(path) for name, path in manifest_paths.items()}
    if any(audit["status"] != "PASS" for audit in manifest_audits.values()):
        raise RuntimeError(f"R5_2B_TC1_PA1_EXECUTION_BLOCKED_IDENTITY: {manifest_audits}")
    checkpoint = torch.load(CHECKPOINT_PATH, map_location="cpu", weights_only=False)
    if int(checkpoint["blank_index"]) != 40 or tuple(checkpoint["vocabulary"]) != PHONE_VOCAB:
        raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_BLOCKED_IDENTITY: checkpoint vocabulary mismatch")
    del checkpoint
    return {
        "status": "PASS", "expected_sha256": EXPECTED_SHA, "actual_sha256": actual,
        "manifest_audits": manifest_audits,
        "scientific_immutability": {
            "contract_sha256": actual["contract"],
            "scorer_sha256": actual["r5_2b_scorer"],
            "tc1_guard_sha256": actual["tc1_guard"],
            "c_formula": "BEST_INSERT_SCORE - BEST_NON_ADDITION_SCORE",
            "hypothesis_families": ["KEEP", "INSERT", "SUB", "DELETE"],
            "empty_target_formula": "SUM_t log_softmax(logits[t])[blank=40]",
            "population_changed": False,
            "loso_changed": False,
            "threshold_helper_changed": False,
            "eight_gates_changed": False,
            "tc1_numeric_policy_changed": False,
            "pa1_root_policy_changed": False,
        },
    }


def verify_train_annotation_paths(
    detail_rows: Mapping[tuple[str, str], Sequence[Mapping[str, Any]]],
) -> dict[str, Any]:
    utterances_by_speaker: dict[str, set[str]] = {speaker: set() for speaker in TRAIN}
    for speaker, utterance_id in detail_rows:
        if speaker not in utterances_by_speaker:
            raise RuntimeError(
                f"R5_2B_PA1_EXECUTION_BLOCKED_ANNOTATION_EXISTENCE: unexpected speaker {speaker}"
            )
        utterances_by_speaker[speaker].add(utterance_id)

    missing: list[str] = []
    ambiguous: list[dict[str, Any]] = []
    by_speaker: dict[str, dict[str, int]] = {}
    for speaker in TRAIN:
        utterances = sorted(utterances_by_speaker[speaker])
        expected = EXPECTED_TRAIN_ANNOTATIONS[speaker]
        existing = 0
        for utterance_id in utterances:
            path = MANUAL_TEXTGRID_ROOT / speaker / "annotation" / f"{utterance_id}.TextGrid"
            if path.is_file():
                existing += 1
            else:
                missing.append(str(path))

        annotation_dir = MANUAL_TEXTGRID_ROOT / speaker / "annotation"
        casefold_names: dict[str, list[str]] = defaultdict(list)
        if annotation_dir.is_dir():
            for path in annotation_dir.glob("*.TextGrid"):
                if path.is_file():
                    casefold_names[path.name.casefold()].append(path.name)
        for names in casefold_names.values():
            if len(names) > 1:
                ambiguous.append({"speaker": speaker, "names": sorted(names)})

        by_speaker[speaker] = {
            "expected": expected,
            "derived_from_v4": len(utterances),
            "existing": existing,
            "missing": len(utterances) - existing,
        }

    total_expected = sum(EXPECTED_TRAIN_ANNOTATIONS.values())
    total_derived = sum(len(values) for values in utterances_by_speaker.values())
    total_existing = sum(item["existing"] for item in by_speaker.values())
    count_mismatch = any(
        by_speaker[speaker]["derived_from_v4"] != EXPECTED_TRAIN_ANNOTATIONS[speaker]
        for speaker in TRAIN
    )

    first_path = MANUAL_TEXTGRID_ROOT / FIRST_ANNOTATION_RELATIVE_PATH
    first_exists = first_path.is_file()
    first_size = first_path.stat().st_size if first_exists else None
    first_sha256 = sha256(first_path) if first_exists else None
    first_match = (
        first_exists
        and first_size == FIRST_ANNOTATION_SIZE
        and first_sha256 == FIRST_ANNOTATION_SHA256
    )
    if not first_match:
        status = "R5_2B_PA1_EXECUTION_BLOCKED_ANNOTATION_PROVENANCE"
    elif count_mismatch or total_derived != total_expected or total_existing != total_expected or missing or ambiguous:
        status = "R5_2B_PA1_EXECUTION_BLOCKED_ANNOTATION_EXISTENCE"
    else:
        status = "PASS"

    return {
        "status": status,
        "scope": "TRAIN_ONLY_EXISTENCE_AND_PROVENANCE_GUARD",
        "roots": {
            "MANUAL_TEXTGRID_ROOT": str(MANUAL_TEXTGRID_ROOT),
            "AUDIO_ROOT": str(AUDIO_ROOT),
            "V4_METADATA_ROOT": str(V4_METADATA_ROOT),
            "logical_roles_independently_configured": True,
            "root_cross_derivation_used": False,
        },
        "path_formula": "MANUAL_TEXTGRID_ROOT/<speaker>/annotation/<utterance_id>.TextGrid",
        "expected": total_expected,
        "derived_from_v4": total_derived,
        ...
        "first_file": {
            ...
            "sha256": first_sha256,
            "expected_byte_size": FIRST_ANNOTATION_SIZE,
            "expected_sha256": FIRST_ANNOTATION_SHA256,
            "match": first_match,
        },
...
def validate_population(words: list[dict[str, Any]], accounting: dict[str, Any]) -> None:
    ...
    if actual != EXPECTED_COUNTS or len(words) != EXPECTED_COUNTS["words"]:
        accounting["status"] = "R5_2B_TC1_PA1_EXECUTION_BLOCKED_ROW_ACCOUNTING"
...
def materialize_and_infer(words: list[dict[str, Any]], device: torch.device) -> tuple[list[torch.Tensor], list[torch.Tensor], dict[str, Any]]:
        ...
        for start in range(0, len(ordered), 8):
            ...
            for position, index in enumerate(indexes):
                ...
                if steps != expected_lengths[index]:
                    raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: output length mismatch")
    ...
    if any(value is None for value in raw_logits) or any(value is None for value in log_probs):
        raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: incomplete inference")
    return (
...
def candidate_audit(words: list[dict[str, Any]], logits: list[torch.Tensor]) -> dict[str, Any]:
    ...
    if int(sum(totals.values())) != expected_total:
        raise RuntimeError(
            f"R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: "
            f"candidate total {sum(totals.values())}!={expected_total}"
        )
    return {
        "status": "PASS" if not keep_impossible_details else "R5_2B_TC1_PA1_EXECUTION_BLOCKED_KEEP_ALIGNABILITY",
...
def batch_ctc_scores(log_probs: list[torch.Tensor], items: list[tuple[int, tuple[int, ...]]], device: torch.device) -> tuple[np.ndarray, np.ndarray]:
    if any(not target for _word_index, target in items):
        raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: empty target entered nonempty CTCLoss batch")
    ...
    for column, (word_index, target) in enumerate(items):
        ...
        if not scorer.is_alignable(target, evidence.shape[0]):
            raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: impossible target entered CTCLoss batch")
    ...
    if not np.isfinite(nll).all():
        raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_NUMERICAL: alignable non-finite loss")
    raw = -nll; target = raw / np.asarray(target_lengths, dtype=np.float64)
    if not np.isfinite(target).all():
        raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_NUMERICAL: derived non-finite score")
    return raw, target
...
def verify_batch_adapter(device: torch.device) -> dict[str, Any]:
    ...
    log_probs = [shared_log_probs.detach().cpu()]
    raw, target = batch_ctc_scores(log_probs, [(0, (1, 2))], device)
    if float(raw[0]) != frozen.raw_score or float(target[0]) != frozen.target_score:
        raise RuntimeError(f"R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: batch adapter mismatch {raw[0]}/{target[0]} vs {frozen.raw_score}/{frozen.target_score}")
    empty_frozen = scorer.score_target(logits, [], 4)
    authoritative_terms = [float(value) for value in shared_log_probs[:, 40].detach().cpu().tolist()]
    diagnostic_terms = [float(value) for value in log_probs[0][:, 40].tolist()]
    empty_batch = float(log_probs[0][:, 40].sum().item())
    dtype_name = str(shared_log_probs.dtype).replace("torch.", "")
    try:
        guard_result = tc1_guard.guard_empty_target_equivalence(
            empty_frozen.target_score,
            empty_batch,
            authoritative_terms,
            diagnostic_terms,
            authoritative_dtype=dtype_name,
            diagnostic_dtype=dtype_name,
            authoritative_backend=str(device),
            diagnostic_backend="cpu",
        )
    except tc1_guard.NonFiniteEmptyTargetError as error:
        raise RuntimeError(error.status) from error
    except tc1_guard.EmptyTargetMismatchError as error:
        raise RuntimeError(error.status) from error
    return {
        "status": "PASS",
        "scope": "deterministic synthetic pre-inference diagnostic",
        "nonempty_raw_score": float(raw[0]),
        "nonempty_target_score": float(target[0]),
        "scorer_device": str(device),
        "scorer_dtype": dtype_name,
        "diagnostic_device": "cpu",
        "diagnostic_dtype": dtype_name,
        "n": len(authoritative_terms),
        "absolute_operand_sum_authoritative": guard_result.authoritative.operand_abs_sum,
        "absolute_operand_sum_diagnostic": guard_result.diagnostic.operand_abs_sum,
        "authoritative_scorer_value_A": guard_result.scientific_score,
        "diagnostic_value_B": guard_result.diagnostic_score,
        "observed_absolute_difference": guard_result.absolute_difference,
        "bound_A": guard_result.authoritative.bound,
        "bound_B": guard_result.diagnostic.bound,
        "correction_bound": guard_result.correction_bound,
        "acceptance_operator": "<=",
        "equivalent": guard_result.equivalent,
        "scientific_score_source": "frozen_r5_2b_scorer",
        "returned_scientific_score": guard_result.scientific_score,
        "diagnostic_replaced_scientific_score": False,
    }
...
def score_train(
        ...
        for family in ("KEEP", "INSERT", "SUB", "DELETE"):
            for candidate_index, candidate in enumerate(family_candidates[word_index][family]):
                if not candidate.target:
                    authoritative = scorer.score_target(
                        raw_logits[word_index].to(device), [], steps
                    ).target_score
                    if not math.isfinite(authoritative):
                        raise RuntimeError(
                            "R5_2B_TC_EXECUTION_TECHNICAL_FAILURE_NONFINITE_EMPTY_TARGET"
                        )
                    values[word_index][family][candidate_index] = authoritative
                    processed_empty += 1
    ...
    for word_index, word in enumerate(words):
        ...
        if not keep.hypothesis.alignable or not math.isfinite(keep.hypothesis.target_score):
            raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_BLOCKED_KEEP_ALIGNABILITY")
    ...
    if processed_nonempty != expected_nonempty:
        raise RuntimeError(f"R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: {processed_nonempty}!={expected_nonempty}")
    return output, {
        "alignable_nonempty_hypotheses_scored": processed_nonempty,
        "empty_delete_hypotheses_scored": processed_empty,
        "empty_delete_score_source": "imported frozen r5_2b_scorer.py",
        "empty_delete_diagnostic_used_as_score": False,
...
def threshold_selection(scores: np.ndarray, truth: np.ndarray, correct_only: np.ndarray) -> tuple[float, dict[str, Any]]:
    ...
    if best_record is None or best_metrics is None:
        raise RuntimeError("R5_2B_TC1_PA1_EXECUTION_TECHNICAL_FAILURE_IMPLEMENTATION: threshold selection empty")
...
def build_report(accounting: dict[str, Any], audit: dict[str, Any], continuous: dict[str, Any], folds: list[dict[str, Any]], binary: dict[str, Any], cohorts: dict[str, Any], events: dict[str, Any], gates: dict[str, Any], status: str) -> str:
    ...
    lines = [
        "# R5-2B Environment-Corrected Frozen TRAIN Development Result", "", f"Status: `{status}`", "",
        "## Population", "",
...
def execute() -> None:
    ...
    environment = verify_authorized_environment()
    identity = verify_identities()
    details, source_scan = r5_1a_driver.scan_train_source()
    path_guard = verify_train_annotation_paths(details)
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_path_guard.json", path_guard)
    if path_guard["status"] != "PASS":
        raise RuntimeError(path_guard["status"])
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    adapter_check = verify_batch_adapter(device)
    preflight = {
        "status": "PASS",
        "execution_label": "ENVIRONMENT-AND-PATH-CORRECTED CONTINUATION OF THE PRE-METRIC R5-2B EXECUTION",
        "authorized_environment": environment,
        "identity_verification": identity,
        "pa1_path_guard": path_guard,
        "tc1_numeric_guard": adapter_check,
        "scientific_contract_modified": False,
        "frozen_scorer_modified": False,
        "tc1_numeric_policy_modified": False,
        "pa1_root_policy_modified": False,
        "scientific_score_source": "imported frozen r5_2b_scorer.py",
        "diagnostic_value_used_as_scientific_score": False,
        "original_failed_execution_preserved": sha256(FAILED_EXECUTION_MANIFEST)
        == EXPECTED_SHA["failed_execution_manifest"],
        "previous_corrected_execution_preserved": sha256(PREVIOUS_CORRECTED_EXECUTION_MANIFEST)
        == EXPECTED_SHA["previous_corrected_execution_manifest"],
        "latest_failed_execution_preserved": sha256(LATEST_FAILED_EXECUTION_MANIFEST)
        == EXPECTED_SHA["latest_failed_execution_manifest"],
    }
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_preflight.json", preflight)

    events_by_word, mapping = r5_1a_driver.map_train_additions(details, MANUAL_TEXTGRID_ROOT)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_population_accounting.json", accounting)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_candidate_audit.json", audit)
    if audit["status"] != "PASS":
        raise RuntimeError(audit["status"])
    scored, scoring_report = score_train(words, raw_logits, log_probs, device)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_continuous_metrics.json", continuous)

    predictions, folds = run_loso(words, scores)
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_loso_thresholds.json", {
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_binary_metrics.json", binary)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_relation_cohort_metrics.json", relation_cohorts)
    events = event_metrics(words, predictions, scored)
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_event_metrics.json", events)
    ...
    write_jsonl(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_train_scores.jsonl", score_rows)
    write_jsonl(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_oof_predictions.jsonl", oof_rows)
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_gate_results.json", gates)
    ...
    protocol = {
        ...
        "tc1_guard_only_correction": True,
        "pa1_path_resolution_only_correction": True,
        "environment_selection_only_correction": True,
        "authorized_interpreter": str(AUTHORIZED_INTERPRETER),
        "authorized_interpreter_verified": True,
        "pa1_train_path_guard": "PASS",
        "train_annotation_expected": path_guard["expected"],
        "train_annotation_existing": path_guard["existing"],
        "manual_textgrid_root": str(MANUAL_TEXTGRID_ROOT),
        "audio_root": str(AUDIO_ROOT),
        "v4_metadata_root": str(V4_METADATA_ROOT),
        "tc1_diagnostic_replaced_scientific_score": False,
        "original_failed_execution_modified": False,
        "previous_corrected_execution_modified": False,
        "latest_failed_execution_modified": False,
        "scientific_contract_modified": False,
        "eight_gates_modified": False,
    }
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_protocol_audit.json", protocol)
    final = {
    ...
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_final_status.json", final)
    compute = {
        ...
        "authorized_environment": environment, "pa1_path_guard": path_guard,
        "tc1_preflight": adapter_check, "inference": inference_report,
        "scoring": scoring_report, "total_seconds_before_hashing": time.perf_counter() - started,
    }
    write_json(EXPERIMENT_DIR / "r5_2b_tc1_pa1_env_compute_report.json", compute)
    report = build_report(accounting, audit, continuous, folds, binary, relation_cohorts, events, gates, status)
    (EXPERIMENT_DIR / "R5_2B_TC1_PA1_ENV_TRAIN_DEVELOPMENT_RESULT.md").write_text(report, encoding="utf-8")

    artifact_names = [
        "r5_2b_train_execution_driver_tc1_pa1_env.py",
        "r5_2b_environment_provenance.json",
        "r5_2b_environment_import_check.json",
        "r5_2b_environment_protocol_audit.json",
        "r5_2b_environment_launcher.json",
    ] + [
        name for name in OUTPUT_NAMES if name != "R5_2B_TC1_PA1_ENV_EXECUTION_MANIFEST.json"
    ]
    entries = [
    ...
    manifest = {
        "manifest_type": "additive environment-and-path-corrected R5-2B frozen TRAIN execution manifest", "self_excluded": True,
        ...
        "preserved_failed_execution_manifest_sha256": EXPECTED_SHA["failed_execution_manifest"],
        "preserved_tc0_manifest_sha256": EXPECTED_SHA["tc0_manifest"],
        "preserved_tc1_contract_manifest_sha256": EXPECTED_SHA["tc1_contract_manifest"],
        "preserved_tc1_static_manifest_sha256": EXPECTED_SHA["tc1_static_manifest"],
        "preserved_previous_corrected_execution_manifest_sha256": EXPECTED_SHA["previous_corrected_execution_manifest"],
        "preserved_pa0_manifest_sha256": EXPECTED_SHA["pa0_manifest"],
        "preserved_pa1_contract_sha256": EXPECTED_SHA["pa1_contract"],
        "preserved_pa1_preregistration_sha256": EXPECTED_SHA["pa1_preregistration"],
        "preserved_pa1_manifest_sha256": EXPECTED_SHA["pa1_manifest"],
        "preserved_latest_failed_execution_manifest_sha256": EXPECTED_SHA["latest_failed_execution_manifest"],
        "technical_correction_only": True,
        "tc1_guard_only_correction": True,
        "pa1_path_resolution_only_correction": True,
        "environment_selection_only_correction": True,
        "authorized_interpreter": str(AUTHORIZED_INTERPRETER),
    }
    write_json(EXPERIMENT_DIR / "R5_2B_TC1_PA1_ENV_EXECUTION_MANIFEST.json", manifest)
    print(json.dumps({
        "status": status, "gates_passed": passed_count, "manifest_sha256": sha256(EXPERIMENT_DIR / "R5_2B_TC1_PA1_ENV_EXECUTION_MANIFEST.json"),
