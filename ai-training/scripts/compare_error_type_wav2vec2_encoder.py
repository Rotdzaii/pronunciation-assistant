...
RUNS = [
    ...
    },
    {
        ...
        "note": "Two-stage CNN pipeline.",
    },
    {
        "name": "wav2vec2_encoder",
        "path": EVALUATION_DIR / "wav2vec2_encoder_error_type_eval_metrics.json",
        "note": "Frozen Wav2Vec2 encoder with mean pooling and classifier head.",
    },
]

OUTPUT_CSV = EVALUATION_DIR / "wav2vec2_encoder_comparison.csv"
