...
MODEL_OUTPUT = Path("ai-training/models/l2_arctic_addition_binary_cnn.pt")
...
def build_sampler(train_df: pd.DataFrame):
    counts = train_df["binary_error_type"].value_counts().to_dict()
    sample_weights = [1.0 / counts[row["binary_error_type"]] for _, row in train_df.iterrows()]
...
def main():
    ...
    df = df[df["error_type"].isin(SOURCE_LABELS)].copy()
    ...
    print()
    print("Source error distribution:")
    print(df["error_type"].value_counts())
    print()
    print("Binary distribution:")
    print(df["binary_error_type"].value_counts())
    print()
    ...
    for split_name, split_df in [("Train", train_df), ("Val", val_df), ("Test", test_df)]:
        print()
        print(f"{split_name} binary distribution:")
        print(split_df["binary_error_type"].value_counts())
            ...
            torch.save(
                {
                    ...
                    "task": "l2_arctic_addition_binary_cnn",
