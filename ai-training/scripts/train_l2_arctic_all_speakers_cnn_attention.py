...
MODEL_OUTPUT = Path("ai-training/models/l2_arctic_all_speakers_cnn_attention.pt")
...
def print_distribution(rows: list[dict[str, str]], title: str, key: str = "error_type") -> None:
...
def main() -> None:
    ...
    print("Architecture: small CNN feature extractor with temporal attention pooling")
    ...
    print_distribution(rows, "All rows by L1:", key="l1")
            ...
            torch.save(
                {
                    ...
                    "task": "l2_arctic_all_speakers_phone_error_type_cnn_attention",
    ...
    print(f"Best validation weighted F1: {best_metrics['weighted_f1']:.4f}")
    print("Best validation per-class precision/recall/F1:")
    for label in LABEL_ORDER:
        item = best_metrics["per_class"][label]
        print(
